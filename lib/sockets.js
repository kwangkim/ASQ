...
var listen = function(server) {
	...
	io.of('/ctrl')
		...
		.on('connection', function(socket) {
			...
			/*
			 * Prototype method for group creation
			 */
	...
	io.of('/folo')
		...
		.on('connection', function(socket) {
			...
			socket.on('asq:propagate', function(evt){
				utils.propagateInRoom(evt.eventname, evt.evt, io, utils.getDisplayName(socket), evt.roomId)
			})
		});
